 ...
 <div class="store-list-container">
        ...
        <div class="search-bar">
            <div class="d-flex">
                ...
                <button class="btn btn-primary ms-2" onclick="searchTable3()">검색</button>
            </div>
            <div>
        ...
        <table class="store-list table table-hover table-bordered">
            <thead>
                <tr>
                    ...
                    <th style="width:7%" class="sortable" onclick="sortTable3(1)">상품번호</th>
                    <th style="width:10%" class="sortable" onclick="sortTable3(2)">카테고리</th>
                    <th style="width:35%" class="sortable" onclick="sortTable3(3)">상품명</th>
                    <th style="width:8%" class="sortable" onclick="sortTable3(4)">판매가</th>
                    <th style="width:8%" class="sortable" onclick="sortTable3(5)">재고</th>
                    <th style="width:10%" class="sortable" onclick="sortTable3(6)">등록일</th>
