...
<div class="ani_view">
    <div class="ani_View">
        <div class="vod_list_select">
            <select name="select_input vod_select" class="select_input vod_select" onchange="onSortChange(this.value)">
...
<div class="ani_viewList">
    <c:forEach var="ani" items="${aniAllList}">
        <div class="div_li" data-anitype="${ani.anitype}" data-agetype="${ani.agetype}">
            ...
            <p class="ani_title_p">${ani.title}</p>
            <p class="genre">
